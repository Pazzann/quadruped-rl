...
All the environments are registered in the `ActuatorTest` extension. They start
...
import ActuatorTest.tasks  # noqa: F401
import gymnasium as gym
from prettytable import PrettyTable


def main():
    """Print all environments registered in `ActuatorTest` extension."""
